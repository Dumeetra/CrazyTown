# CrazyTown 
 ...
 ##### The cars can turn right or left. If the car receives no mouse input (hover the mouse over a car and click the mouse) before reaching an intersection, it continues going straight.  
